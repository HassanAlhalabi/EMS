...
const ProfileMenu = () => {
  ...
  return (
      <>
        ...
        <Link className="dropdown-item" to="/profile"> <span className="fas fa-user me-1"></span>  {t('profile_account')}</Link>
        ...
        <a className="dropdown-item" href="#" onClick={e => handleLogOut(e)}> <span className="fas fa-sign-out me-1"></span>  {t('logout')}</a>
      </>
  )
}
